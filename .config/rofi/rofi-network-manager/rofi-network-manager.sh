...
function initialization() {
	...
	{ [[ -f "$DIR/rofi-network-manager.rasi" ]] && RASI_DIR="$HOME/.config/rofi/rofi-network-manager/rofi-network-manager.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi"; } || exit
